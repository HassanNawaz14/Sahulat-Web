...
export default function ProjectionCard({ dailyRate, daysRemaining, projectedUnits, estimatedBill, currentSlabRate, utilityType = "electricity" }: Props) {
  ...
  return (
    <div className="rounded-xl border bg-gradient-to-br from-blue-50 to-white p-5">
      ...
      <p className="text-sm text-gray-600">
        At <strong>{dailyRate.toFixed(1)} {labels.rate}</strong>, you'll use ~<strong>{projectedUnits.toFixed(0)} {labels.unit}</strong>{" "}
